...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: Arial, sans-serif; }
        ...
        /* HEADER - Royal Indigo / Slate accents */
        header {
            height: 60px;
        ...
        header .logout-btn:hover { background-color: #f87171; color: #ffffff; }
...
<body>
    ...
    <!-- Top Header -->
    <header>
        <div class="logo">HMS - Admin Portal</div>
        <div>
